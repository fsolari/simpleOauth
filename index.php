...
<head>
  ...
  <meta property="og:title" content="Un solo token para todas tus llamadas a la API de Mercado Libre" />
        ...
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    ...
                    <p style="color:white;">Guardamos y renovamos de forma segura<br/>tu access_token para ti. <a style="color:white;" target="_blank" href="https://youtu.be/QLBHXEcIijg">Descubre el tutorial.</a></p><br/>
